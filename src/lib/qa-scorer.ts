...
function buildQAPrompt(
  ...
  const textCheck = isInfografia
    ? `CONTEXT — INFOGRAFIA SHOT: The hero (Image 3) is a marketing infographic with text, logos, icons, checkmarks, and a "Banva Home vs Others" comparison layout. All of that text content IS PART OF THE HERO and MUST appear in the generated image. Preserving those text overlays is REQUIRED, not a violation. Score ml_compliance = 1.0 as long as the text from Image 3 is still legible in Image 1.`
...
7. **ml_compliance** (0-1): Is this suitable for MercadoLibre?
   ...
   ${isInfografia ? `- INFOGRAFIA SHOT: the hero is a comparison infographic with text, "BANVA HOME" logo, checkmarks, and layout. All of this text/logo content IS PART of the hero and MUST appear preserved in Image 1. Score 1.0 as long as the hero text is still present and legible. Do NOT penalize for the "BANVA HOME" logo — it belongs in the image.`
